...
class TestUpdateScript(unittest.TestCase):
    ...
    def install_line(self):
        found = [l for l in self.lines if 'pip install' in l and 'requirements.txt' in l]
    ...
    def test_the_theme_pin_is_filtered_out(self):
        filtered = [l for l in self.lines if 'sphinx_rtd_theme' in l and 'requirements.txt' in l]
    ...
    def test_requirements_list_the_delta_writer(self):
        ...
        self.assertIn('zstandard', [l.strip() for l in reqs])
